...
// include: /tmp/tmp5ub51j39.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'sudokuSolver.data';
      var REMOTE_PACKAGE_BASE = 'sudokuSolver.data';
...
Module['FS_createPath']("/assets", "font", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_sudokuSolver.data');

      };
      Module['addRunDependency']('datafile_sudokuSolver.data');
    ...
    loadPackage({"files": [{"filename": "/assets/font/Bangers-Regular.ttf", "start": 0, "end": 92468}, {"filename": "/assets/font/BebasNeue-Regular.ttf", "start": 92468, "end": 150144}, {"filename": "/assets/font/Boldonse-Regular.ttf", "start": 150144, "end": 227312}], "remote_package_size": 227312});

  })();

// end include: /tmp/tmp5ub51j39.js
// include: /tmp/tmpuk60oq4b.js
  ...
  // end include: /tmp/tmpuk60oq4b.js
// include: /tmp/tmpng9gkf6u.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpng9gkf6u.js
...
function findWasmBinary() {
    return locateFile('sudokuSolver.wasm');
}
...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 0, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(13, 0, 1, title);
